      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-6 w-full max-w-sm animate-fade-in-down">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full cursor-pointer text-left px-4 py-3 text-sm text-gray-200 hover:bg-gray-700 flex items-center justify-between gap-3 transition-colors rounded-lg"
          >
